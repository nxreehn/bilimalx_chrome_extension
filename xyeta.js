...
(function () {
	...
	var version_modss = '2.7.3', API = Lampa.Utils.protocol() + 'api.lampa.stream/', type = '', jackets = {}, cards, ping_auth, manifest, menu_list = [], vip = false, user_id = '', uid = 'd9c544d0aaddfd20c051', IP, logged = false;
